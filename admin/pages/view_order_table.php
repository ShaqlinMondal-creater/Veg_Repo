                ...
                <table class="table align-items-center justify-content-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs text-center font-weight-bolder opacity-7 ps-2">Billing</th>
                      <th class="text-uppercase text-secondary text-xxs text-center font-weight-bolder opacity-7 ps-2">Shipping</th>
                  ...
                  <tbody>
                    <?php
                        $c=1;
                        $sel="SELECT * FROM sub_order INNER JOIN master_order ON sub_order.mo_id=master_order.id INNER JOIN product ON sub_order.pro_id=product.id";
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 ">
                            <div class="my-auto">
                                <h6 class="mb-0 text-sm text-center"><?php echo $rs['pro_id'];?></h6>
                            </div>
                            <div>
                                <img src="../pll/<?php echo $rs['picc'];?>" class="avatar avatar-sm rounded-circle me-2" alt="spotify">
                            </div>
                            <div class="my-auto">
                              <a href="view_orderby_customer.php?orid=<?php echo $rs['mo_id']; ?>">
                                <h6 class="mb-0 text-sm text-center"><?php echo $rs['name'];?></h6>
                              </a>
                            </div>
                        </div>
                      </td>
                      ...
                      <td>
                        <p class="text-xs text-center font-weight-bold">ui# <?php echo $rs['customer_id'];?></p>
                      </td>
                      <td>
                        <p class="text-sm text-center font-weight-bold mb-0">c# <?php echo $rs['cart_id'];?></p>
                      </td>
                      <td class="align-middle text-center">
                        <p class="text-sm text-center font-weight-bold mb-0">## <?php echo $rs['mo_id'];?></p>
                      </td>
                      <td>
                        <p class="text-sm text-center font-weight-bold mb-0"><?php echo $rs['pro_qty'];?> pcs</p>
                      </td>
                      <td>
                        <p class="text-sm text-center text-warning font-weight-bold mb-0">BILLING</p>
                        <p class="text-sm text-center text-info font-weight-bold mb-0">Name : 
                          <?php echo $rs['bill_name']; ?>
                        </p>
                        <p class="text-sm text-center text-info font-weight-bold mb-0">Email : 
                          <?php echo $rs['bill_email']; ?>
                        </p>
                        <p class="text-sm text-center text-info font-weight-bold mb-0">Phone : 
                          <?php echo $rs['bill_phone']; ?>
                        </p>
                        <p class="text-sm text-center text-info font-weight-bold mb-0">Address : 
                          <?php echo $rs['bill_address']; ?>
                        </p>
                      </td>
                      <td>
                        <p class="text-sm text-center text-warning font-weight-bold mb-0">SHIPPING</p>
                        <p class="text-sm text-center text-info font-weight-bold mb-0">Name : 
                      ...
                      <td>
                        <a href="view_customer.php?cid=<?php echo $rs['user_id']; ?>">
                          <p class="text-sm text-center font-weight-bold mb-0"><?php echo $rs['customer_name'];?></p>
                        </a>
                      </td>
                      <td>
                        <p class="text-sm text-center font-weight-bold mb-0"><?php echo $rs['order_date'];?></p>
                      </td>
                      <td class="align-middle text-center">
                        <a href="delete_order.php?oid=<?php echo $rs['mo_id']; ?>" onclick="return confirm('Are you want to delete ?')" class="text-secondary font-weight-bold text-xs btn btn-danger"  data-toggle="tooltip" data-original-title="Edit user">
